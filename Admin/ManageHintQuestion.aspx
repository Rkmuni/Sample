<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ManageHintQuestion.aspx.cs" Inherits="Admin_ManageHintQuestion" %>
...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="ControlPanelContentPlaceHolder">
    ...
    <tr>
        <td style="margin:10px;vertical-align:top">
            <table style="width:60%"><a href="Default.aspx">Default.aspx</a>
                <tr>
                    <td colspan="3"><b>Manage HintQuestion</b></td>
                </tr>
                <tr>
                    <td style="width:20%;text-align:left"><b>Hint Question</b></td>
                    <td style="width:2%">:</td>
                    <td style="width:20px"><asp:TextBox ID="txtSearchHintQuestion" runat="server" ></asp:TextBox>&nbsp;
                ...
                <tr>
                    <td colspan="2">
                        &nbsp;</td>
                    <td align="right">
                        <asp:Button ID="imgBtnAdd" runat="server" Text="Add HintQuestion" OnClick="imgBtnAdd_Click"/>
                    </td>
                </tr>
                <tr>
                    <td colspan="3">
                        <asp:GridView ID="grvHintQuestion" runat="server" AutoGenerateColumns="False" HeaderStyle-Height="9px" RowStyle-Height="12px" Width="100%" Height="100" DataKeyNames="HintQuestionId" BackColor="White" BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px" CellPadding="4" AllowSorting="true" AllowPaging ="true" OnSorting="grvHintQuestion_Sorting" OnPageIndexChanging="grvHintQuestion_PageIndexChanging" GridLines="Both" PageSize="3" OnSelectedIndexChanged="grvHintQuestion_SelectedIndexChanged">
                            <Columns>
...
<ItemStyle Width="10%"></ItemStyle>
                                ...
                                <asp:BoundField DataField="HintQuestion" HeaderText="Hint Question" SortExpression="HintQuestion" ItemStyle-Width="60%" >
...
<ItemStyle Width="10%"></ItemStyle>
    ...
    <asp:Panel ID="panelAdd" runat="server" style="border-radius:10px" Width="700" BorderWidth="2" BorderColor="Green" BorderStyle="Solid" BackColor="WhiteSmoke">
        <asp:Panel ID="panelAddTitle" runat="server" style="border-radius:10px;cursor:move" Width="100%" HorizontalAlign="Center" BackColor="Blue" ForeColor="Beige">
          <table width="100%"><tr><td style="text-align:center;width:90%"> <b style="width:95%">Add HintQuestion Details  </b></td>
        ...
        <table style="width:100%">
            ...
            <tr>
                <th style="text-align:right;width:25%">HintQuestion</th>
                <th>:</th>
                <td style="text-align:left;">
                    <asp:TextBox ID="txtAddHintQuestion" runat="server" ValidationGroup="AddHintQuestion"></asp:TextBox>
                    <asp:RequiredFieldValidator ID="rfv1" runat="server" ControlToValidate="txtAddHintQuestion" ErrorMessage="Please Enter Hint Question" Display="None" ValidationGroup="AddHintQuestion">
            ...
            <tr>
                <td colspan="2"></td>
                <td><asp:Button ID="btnSave" runat="server" Text="Save" OnClick="btnSave_Click" ValidationGroup="AddHintQuestion" />&nbsp
    ...
    <asp:Panel ID="PanelEdit" runat="server" BackColor="WhiteSmoke" Width="800" BorderWidth="2" BorderStyle="Solid" BorderColor="Blue">
        ...
        <table style="width:100%">
            ...
            <tr>
                <th>Hint Question</th>
                <th>:</th>
                <td><asp:TextBox ID="txtEditHintQuestion" runat="server" ValidationGroup="EditHintQuestion"></asp:TextBox>
                    <asp:RequiredFieldValidator ID="rfv2" runat="server" ControlToValidate="txtEditHintQuestion" ErrorMessage="Please Enter Hint Question" Display="None" ValidationGroup="EditHintQuestion">
            ...
            <tr>
            <td colspan="2"></td>
            <td><asp:Button ID="btnUpdate" runat="server" Text="Update" OnClick="btnUpdate_Click" ValidationGroup="EditHintQuestion"/>&nbsp
